...
function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function componentDidMount() {
      if (this.props.router.query.name === "first") {
        console.log(this.props.router.query, "did mount", window.location);
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=particle.js.cc0ac0bbdadd762a90b3.hot-update.js.map
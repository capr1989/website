...
var Inner = _emotion_styled__WEBPACK_IMPORTED_MODULE_3__["default"].div(_templateObject4(), function (props) {
  console.log(props);
  return "rgb(".concat((props.color, props.color, props.color), ")");
}, function (props) {
  props.height;
});
  ...
  _createClass(Second, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Container, {
        ...
        defaultStyle: {
          height: 0,
          color: "rgb(".concat((0, 0, 0), ")")
        },
        style: {
          height: this.state.height,
          color: "rgba(".concat((Object(react_motion__WEBPACK_IMPORTED_MODULE_4__["spring"])(20), 0, 0), ")")
        }
      }, function (val) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Row, {
          ...
          className: "col-12"
        }, console.log(val), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
          ...
          style: {
            height: val.height,
            color: "rgb(".concat((val.color, val.color, val.color), ")")
          }
...
//# sourceMappingURL=animation.js.2e167aab6cb44ac3a39e.hot-update.js.map
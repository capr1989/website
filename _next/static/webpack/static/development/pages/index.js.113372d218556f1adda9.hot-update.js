    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            obj.props.data = _context.sent;
            _context.next = 6;
            return obj.props.data.json();
          ...
          case 12:
            console.log(obj);
            _context.next = 15;
            return obj.props.data.splice(0, 10);
...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      hoistedIndex.getInitialProps(this); // const { data } = this.props;
      // const renderData = () => {
      //   return data.map(d => {
      //     return (
      //       <Link
...
//# sourceMappingURL=index.js.113372d218556f1adda9.hot-update.js.map
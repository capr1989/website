...
var Inner = _emotion_styled__WEBPACK_IMPORTED_MODULE_3__["default"].div(_templateObject4(), function (props) {
  console.log(props);
  return "rgba(".concat(props.color, ")");
}, function (props) {
  props.height;
});
  ...
  _createClass(Second, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Container, {
        ...
        defaultStyle: {
          height: 0,
          color: "rgba(".concat((0, 0, 0, 0), ")")
        },
        style: {
          height: this.state.height,
          color: "rgba(".concat((Object(react_motion__WEBPACK_IMPORTED_MODULE_4__["spring"])(20), 0, 0, 0), ")")
        }
      }, function (val) {
...
//# sourceMappingURL=animation.js.da1e281ecd9ec5c8fb1b.hot-update.js.map
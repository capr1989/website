...
function (_React$Component) {
  ...
  _createClass(Animation, [{
    ...
    value: function render() {
      ...
      var classCondition = function classCondition(ANI) {
        if (_this.props.data.name && ANI === __webpack_require__("./components/animation sync recursive ^\\.\\/.*$")("./" + upperCaseLink(_this.props.data.name)).default) {
...
//# sourceMappingURL=animation.js.c47cb869dc5373d1c4e8.hot-update.js.map
...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      var newThis = hoistedIndex.getInitialProps(this);
      console.log(newThis, "uiju"); // const { data } = this.props;
      // const renderData = () => {
      //   return data.map(d => {
      //     return (
      //       <Link
...
//# sourceMappingURL=index.js.8de5baf076d8683df468.hot-update.js.map
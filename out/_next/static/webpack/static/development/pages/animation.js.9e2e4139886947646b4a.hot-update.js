  ...
  _createClass(AnimationLinks, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        ...
        console.log(query === p.name || _this.mountQuery === p.name ? "cust__active col nav-link" : "col nav-link", "classNames");
        console.log(query === p.name || _this.mountQuery === p.name, "bool condition");
        console.log(query, p.name);
        console.log(_this.mountQuery, p.name);
...
//# sourceMappingURL=animation.js.9e2e4139886947646b4a.hot-update.js.map
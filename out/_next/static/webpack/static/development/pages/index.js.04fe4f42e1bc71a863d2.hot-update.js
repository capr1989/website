...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      hoistedIndex.getInitialProps(this);
      console.log(hoistedIndex.getInitialProps(this), "uiju"); // const { data } = this.props;
      // const renderData = () => {
      //   return data.map(d => {
      //     return (
      //       <Link
...
//# sourceMappingURL=index.js.04fe4f42e1bc71a863d2.hot-update.js.map
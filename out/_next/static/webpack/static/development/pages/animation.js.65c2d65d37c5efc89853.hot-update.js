...
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  border-radius: 99px;\n  background-color: hotpink;\n  width: 50px;\n  height: 50px;\n  -webkit-box-shadow: 10px 10px 36px 1px rgba(0, 0, 0, 0.5);\n  -moz-box-shadow: 10px 10px 36px 1px rgba(0, 0, 0, 0.5);\n  box-shadow: 10px 10px 36px 1px rgba(0, 0, 0, 0.5);\n  position: absolute;\n"]);
...
//# sourceMappingURL=animation.js.65c2d65d37c5efc89853.hot-update.js.map